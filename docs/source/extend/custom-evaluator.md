...
- `full_dataset_entry`: The entire dataset entry as a dictionary. This field provides access to additional fields (e.g., metadata, labels) that are not part of the standard workflow inputs but may be useful for evaluation.
